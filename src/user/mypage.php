        ...
        <div class="profile-section">
            <form method="post" action="../action/upload_profile_image.php" enctype="multipart/form-data">
                <?php
                    ...
                    ? htmlspecialchars($users['profile_image'], ENT_QUOTES, 'UTF-8')
    ...
    <div class="mypage-content">
                    ...
                    <div class="reservation-card">
                        ...
                        <div class="reservation-details">
                            ...
                            <div class="mypage-detail-item">
                                ...
                                <span><?= htmlspecialchars($reservation['guests'], ENT_QUOTES, 'UTF-8') ?>명</span>
                            </div>
                        </div>
                        <?php if($reservation['status'] == 'done'): ?>
                        <form method="post" action="../action/reservation_cancel_action.php">
        ...
        <section id="profile" class="content-section">
            ...
            <div class="profile-form-container">
                <form class="profile-form" method="post" action="../action/mypage_change_action.php">
                    <div class="mypage-form-group">
                        <label for="username">이름</label>
                        <input type="text" id="username" name="username" value="<?= htmlspecialchars($users['username'], ENT_QUOTES, 'UTF-8') ?>" readonly class="readonly-input">
                    </div>
                    <div class="mypage-form-group">
                ...
                <table class="wishlist-table">
                    ...
                    <?php foreach ($wishlist_items as $hotel): ?>
                        <tr>
                            <td>
                                <div class="hotel-row">
                                    <h3 class="hotel-name"><?= htmlspecialchars($hotel['name'], ENT_QUOTES, 'UTF-8') ?></h3>
                                </div>
                            </td>
                            <td>
                                <div class="button-group">
                                    <a href="../hotel/hotel-detail.php?id=<?= htmlspecialchars($hotel['hotel_id'], ENT_QUOTES, 'UTF-8') ?>" class="detail-btn">상세보기</a>
                                    <form method="post" action="../action/wishlist_delete.php" style="display:inline;">
        ...
        <section id="point" class="content-section">
            ...
            <div class="profile-form-container">
                ...
                <form action="../action/charge_point_action.php" method="post">
                    <div class="mypage-form-group">
