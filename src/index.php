<?php 
// 보안 헤더 적용 (XSS 방지 등)
header("Content-Security-Policy: default-src 'self'; img-src *; style-src 'self' 'unsafe-inline'; script-src 'self'");
    ...
    <section class="style-featured-hotels">
        ...
        <div class="style-hotel-grid">
            ...
            <div class="style-hotel-card">
                <img src="<?= htmlspecialchars($hotel['main_image']) ?>" alt="<?= htmlspecialchars($hotel['name']) ?>" class="hotel-image">
                <div class="style-hotel-info">
                    <h3 class="hotels-name"><?= htmlspecialchars($hotel['name']) ?></h3>
                    ...
                    <div class="hotel-actions">
                        <a href="hotel/hotel-detail.php?id=<?= urlencode($hotel['hotel_id']) ?>" class="style-detail-btn">상세보기</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
